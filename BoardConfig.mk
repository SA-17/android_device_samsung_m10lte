...
BOARD_PREBUILT_DTB := device/samsung/m10lte/prebuilt/dt.img
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPSA09A008RU"
BOARD_MKBOOTIMG_ARGS += --recovery_dtb $(BOARD_PREBUILT_DTB)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/m10lte/mkboot/bootimg.mk
...
TW_DEVICE_VERSION := Samsung Galaxy M10
